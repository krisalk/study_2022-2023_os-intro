...
![выполнение команд](image/2.png){#fig:001 width=70%}
...
![выполнение команд](image/cat f.png){#fig:001 width=70%}

4.8. Что произойдёт, если вы попытаетесь скопировать файл ~/feathers?

![выполнение команд](image/cp f.png){#fig:001 width=70%}
...
![man](image/5.5.png){#fig:001 width=70%}
